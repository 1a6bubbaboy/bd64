@ECHO OFF                                                                                                     
									SET "PHP_PEAR_SYSCONF_DIR=C:\wordpress-4.6-1\php"
...
FOR %%x IN ("C:\wordpress-4.6-1\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\wordpress-4.6-1\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\wordpress-4.6-1\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\wordpress-4.6-1\php\php.exe"
GOTO :INSTALLED
