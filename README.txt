...
Bitnami WordPress Stack ships with the following software versions:
  ...
  - WordPress 4.6
  - Apache 2.4.23
  - Varnish (Only supported on Linux and OS X)
  - MySQL 5.7.14
  - PHP 7.0.10
  - phpMyAdmin 4.6.4
...
bitnami-wordpress-4.6-1-linux-installer.run on Linux or
bitnami-wordpress-4.6-1-linux-x64-installer.run on Linux 64 bit or
bitnami-wordpress-4.6-1-windows-installer.exe on Windows or
bitnami-wordpress-4.6-1-osx-x64-installer.dmg on OS X.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-wordpress-4.6-1-linux.run
...
in /home/user/wordpress-4.6-1 on Linux or 
C:\Bitnami\wordpress-4.6-1 on Windows or 
/Applications/wordpress-4.6-1 on OS X and that you use port 8080 
...
/home/user/wordpress-4.6-1/apache2/logs/error.log on Linux or
C:\bitnami\wordpress-4.6-1\apache2\logs\error.log on Windows or
/Applications/wordpress-4.6-1/apache2/logs/error.log.
